...
input.onchange = () => { img.src =  window.URL.createObjectURL(input.files[0]); img.onload = () => {context.drawImage(img, 0, 0); alert(context.getImageData(0,0, img.width, img.height).data[0]); }}
